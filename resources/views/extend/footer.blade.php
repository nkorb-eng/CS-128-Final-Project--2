<footer class="bg-dark text-white pt-5 pb-3 w-100">
  <div class="container-fluid px-5">
    <div class="row g-4">
      
      <div class="col-lg-4 col-md-6">
        <h5 class="text-white mb-3 fw-bold user-select-none">BLUEBIRD</h5>
        <p class="text-white-50 small">
          Experience luxury, comfort, and exceptional service. Your perfect stay awaits at Bluebird Hotel.
        </p>
      </div>
    ...
    <div class="row align-items-center">
      <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
        <p class="text-white-50 small mb-0">
          &copy; {{ date('Y') }} Bluebird Hotel. All rights reserved.
        </p>
      </div>
...
<style>
  /* Keeps the links a readable muted white, but highlights them to bright white on hover */
  .hover-link {
