        ...
        <div class="col-lg-10">
            <div class="card shadow border-0 rounded-3 overflow-hidden">
                ...
                <div class="bg-dark text-white p-4 text-center">
                    <h2 class="fw-bold m-0"><i class="fa-solid fa-bookmark me-3 text-success"></i>HOTEL BLUEBIRD RESERVATION</h2>
                    ...
                    <form action="{{ route('room.book.submit') }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 border-end pe-md-4">
                                <h4 class="fw-bold mb-4 text-secondary border-bottom pb-2"><i class="fa-solid fa-user me-2"></i>Guest Information</h4>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="Email" value="{{ session('usermail') }}" class="form-control bg-white text-muted" readonly>
                                </div>
                            ...
                            <div class="col-md-6 ps-md-4">
                                <h4 class="fw-bold mb-4 text-secondary border-bottom pb-2"><i class="fa-solid fa-hotel me-2"></i>Reservation Details</h4>
                                
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Type of Room</label>
                                    <select name="RoomType" id="room_type" class="form-select" onchange="calculateLiveEstimate()" required>
                                        <option value="" disabled>Select Room Type</option>
                                        <option value="Superior Room" {{ $selectedRoom == 'Superior Room' ? 'selected' : '' }}>SUPERIOR ROOM</option>
                                        <option value="Deluxe Room" {{ $selectedRoom == 'Deluxe Room' ? 'selected' : '' }}>DELUXE ROOM</option>
                                        <option value="Guest House" {{ $selectedRoom == 'Guest House' ? 'selected' : '' }}>GUEST HOUSE</option>
                                        <option value="Single Room" {{ $selectedRoom == 'Single Room' ? 'selected' : '' }}>SINGLE ROOM</option>
                                    </select>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Bedding Layout Configuration</label>
                                    <select name="Bed" id="bedding" class="form-select" onchange="calculateLiveEstimate()" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="Meal" id="meal_plan" class="form-select" onchange="calculateLiveEstimate()" required>
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <input name="cin" id="check_in" type="date" class="form-control" onchange="calculateLiveEstimate()" required>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label fw-semibold">Check Out Date</label>
                                        <input name="cout" id="check_out" type="date" class="form-control" onchange="calculateLiveEstimate()" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5 pt-3 border-top">
                            ...
                            <div class="text-start">
                                <span class="text-muted fw-semibold d-block small uppercase text-tracking">Estimated Total Price:</span>
                                <span class="fs-2 fw-bold text-success" id="livePriceDisplay">$ 0.00</span>
                            </div>

                            <div class="text-end">
                                <a href="{{ route('home') }}" class="btn btn-outline-secondary px-5 py-2 me-2 fw-bold">Cancel</a>
                                <button type="submit" class="btn btn-success px-5 py-2 fw-bold">Submit Booking Order</button>
                            </div>
...
function calculateLiveEstimate() {
        ...
        switch (roomType) {
            ...
            case 'Guest House':   basePrice = 12.00; break;
            case 'Deluxe Room':   basePrice = 22.00; break;
