            ...
            <div class="col-md-8">
                <div class="card profile-card p-5 mt-4">
                    ...
                    <div class="text-center mt-5">
                        <a href="{{ route('user.profile.edit') }}" class="btn btn-outline-primary px-4 me-2"><i
                                class="fa-solid fa-pen-to-square me-2"></i>Edit Profile</a>
                        <a href="{{ route('user.password.edit') }}" class="btn btn-outline-danger px-4"><i
                                class="fa-solid fa-key me-2"></i>Change Password</a>
                    </div>
