...
<body>
    <div class="searchsection d-flex align-items-center justify-content-between p-3">
        ...
        <h4 class="text-white m-0 pe-4"><i class="fa-solid fa-file-invoice-dollar me-2"></i>Payments & Billing</h4>
    </div>
            ...
            @foreach ($payments as $res)
                <tr>
                    ...
                    <td class="action text-nowrap text-center">
                        ...
                        <a href="{{ route('admin.payment.delete', $res->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Delete payment record?')">
